...
public class MainActivity extends AppCompatActivity {
    ...
    class DBHelper extends SQLiteOpenHelper {
        ...
        @Override public void onUpgrade(SQLiteDatabase db, int o, int n) {
            ...
            try{db.execSQL("CREATE TABLE IF NOT EXISTS pdf_ocr_cache (pdf_uri TEXT, page INTEGER, ocr_text TEXT, blocks TEXT, PRIMARY KEY(pdf_uri, page))");}catch(Exception e){}
            try{db.execSQL("CREATE TABLE IF NOT EXISTS search_history (pdf_uri TEXT, query TEXT, found_page INTEGER, ts DATETIME DEFAULT CURRENT_TIMESTAMP)");}catch(Exception e){}
